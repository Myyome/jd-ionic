...
* Description
*/
angular.module('goodist.goodistservice', [])
.factory('goodistservice', ['$q',function($q){
	return {
		//下拉刷新
		refreshGoodsList: function (message) {
        var obj_goodsListData = [
          {
            name: '奥贝琳 2015秋冬新款韩版修身显瘦中长款毛呢大衣女外套  8615  灰色 L',
            price: '198',
            haoping: '99',
            buy: '81',
            productId: "1",
        ...
        defferred.resolve(obj_goodsListData);
